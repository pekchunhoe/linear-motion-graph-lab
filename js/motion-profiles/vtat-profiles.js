...
const definitions = [
  { profileId: 'original', title: 'Original multi-stage journey', category: 'Multi-stage', previewLabel: 'Several acceleration stages',
  ...
  { profileId: 'constant-forward', title: 'Constant forward velocity', category: 'Basic motion', previewLabel: 'Constant positive velocity',
  ...
  { profileId: 'from-rest', title: 'Accelerating from rest', category: 'Accelerated motion', previewLabel: 'Velocity rises linearly',
  ...
  { profileId: 'slowing-forward', title: 'Slowing down forward', category: 'Accelerated motion', previewLabel: 'Velocity falls to zero',
  ...
  { profileId: 'reverse', title: 'Forward → stop → reverse', category: 'Reversal', previewLabel: 'Crosses through zero',
  ...
  { profileId: 'negative-to-forward', title: 'Backward → stop → forward', category: 'Reversal', previewLabel: 'Crosses upward through zero',
  ...
  { profileId: 'cruise', title: 'Accelerate → cruise → decelerate', shortTitle: 'Accelerate, cruise, decelerate', category: 'Multi-stage', previewLabel: 'Rise, level, then fall',
  ...
  { profileId: 'constant-backward', title: 'Constant backward velocity', category: 'Basic motion', previewLabel: 'Constant negative velocity',
